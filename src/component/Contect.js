  ...
  return (
    <div className="w-full  flex justify-between items-center px-[20%] lg:px-[15%] md:px-[25%] sm:px-[20%] xs:px-[5%]  py-[5%] bg-gray-100">
      <div className=" w-[45%] lg:w-[40%] md:hidden sm:hidden xs:hidden">
        ...
        <h1 className="font-bold text-4xl lg:text-3xl">Tell me about your projects.</h1>
        <p className="my-[7%] text-lg lg:text-base">Let's create something togather</p>
      </div>
        ...
        <div className="w-[80%] text-center flex-col mx-[10%]">
          ...
          <div className="w-full flex justify-center my-[3%]">
            <select
              name=""
              id=""
              className="w-full border border-gray-300 rounded-md bg-gray-100 py-[1%] px-[2%] "
            >
              <option value="" className="" selected hidden>
                options
              </option>
          ...
          <div className="w-full mb-[3%] mt-[6%]">
            <button className=" border border-gray-300 float-left bg-gray-100 w-[30%] rounded text-gray-600  py-[1%] px-[2%]  hover:border-gray-800 hover:font-semibold">
              SUBMIT
            </button>
          </div>
        </div>
